"""
AI Resume-Job Matcher - Professional Frontend
Ultra-modern, minimalist UI inspired by Apple/Samsung/Nike design philosophy
"""
...
st.set_page_config(
    page_title="Resume Matcher - AI Career Intelligence",
    layout="wide",
    initial_sidebar_state="expanded",
    menu_items={
        'Get Help': 'https://github.com',
        'Report a bug': 'https://github.com',
        'About': "Resume Matcher - Professional AI-powered career analysis"
    }
)
...
def main():
    ...
    if not check_api_health():
        st.error("Backend server offline. Please start the API service.")
